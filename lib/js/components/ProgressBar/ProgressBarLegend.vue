...
const itemSize = computed(() => {
	switch (size) {
		case PROGRESS_BAR_LEGEND_SIZES.SMALL:
			return PROGRESS_BAR_LEGEND_ITEM_SIZES.SMALL;
		case PROGRESS_BAR_LEGEND_SIZES.MEDIUM:
			return PROGRESS_BAR_LEGEND_ITEM_SIZES.MEDIUM;
		default:
			return undefined;
	}
});
