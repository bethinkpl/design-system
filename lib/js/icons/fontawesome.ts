...
import { faHighlighterLine } from '@fortawesome/pro-regular-svg-icons/faHighlighterLine';
...
export const FONTAWESOME_ICONS = {
	...
	FA_ARROW_DOWN_BIG_SMALL: faArrowDownBigSmall,
	...
	FA_BULLSEYE_POINTER: faBullseyePointer,
	FA_BRAIN: faBrain,
	...
	FA_FILM: faFilm,
	FA_FILTER: faFilter,
	FA_FLAG_CHECKERED_SOLID: fasFlagCheckered,
	FA_FLAG: faFlag,
	...
	FA_HIGHLIGHTER_LINE: faHighlighterLine,
