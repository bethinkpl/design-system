import{D as o,a as l,b as c,c as d,d as D}from"./DatePicker-Cetq55lz.js";import{I as p}from"./Icon-DI8g7n3G.js";import{D as g}from"./Switch-B_PehrtT.js";import"./iframe-DoBjvBJb.js";import"../sb-preview/runtime.js";import"./vue.esm-bundler-DjLn_Drf.js";import"./Tile-B5MClcPg.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const{useArgs:b}=__STORYBOOK_MODULE_PREVIEW_API__,x={title:"Components/DatePickers/DatePicker",component:o},h=m=>{const[I,u]=b();return{components:{DatePicker:o,DsSwitch:g},setup(){return m},data(){return{ICONS:Object.freeze(p)}},methods:{updateDate(t){u({date:`${t.getFullYear()}-${t.getMonth()+1}-${t.getDate()}`})}},computed:{formattedDate(){return this.date?new Date(this.date):null},formattedMinDate(){return this.minDate?new Date(this.minDate):null},formattedMaxDate(){return this.maxDate?new Date(this.maxDate):null},formattedDisableDates(){return!this.disableDates||!this.disableDates.length?null:this.disableDates.map(t=>new Date(t))}},template:`
            <date-picker
