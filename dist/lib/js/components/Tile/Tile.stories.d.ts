...
declare const _default: Meta<{
    ...
    props: {
        ...
        iconLeft: {
            type: ObjectConstructor;
            default: null;
            validator(iconLeft: import("vue").VueConstructor<import("vue").default>): boolean;
        };
        iconRight: {
            type: ObjectConstructor;
            default: null;
            validator(iconRight: import("vue").VueConstructor<import("vue").default>): boolean;
        };
        text: {
            type: StringConstructor;
            required: boolean;
...
export declare const Static: StoryFn<{
    name: string;
    components: {
        DsIcon: {
            name: string;
