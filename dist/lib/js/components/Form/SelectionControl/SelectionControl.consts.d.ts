...
export type SelectionControlSize = typeof SELECTION_CONTROL_SIZE[keyof typeof SELECTION_CONTROL_SIZE];
export declare const SELECTION_CONTROL_STATE: {
    readonly DEFAULT: "default";
    readonly DISABLED: "disabled";
    readonly LOADING: "loading";
};
export type SelectionControlState = typeof SELECTION_CONTROL_STATE[keyof typeof SELECTION_CONTROL_STATE];
