import{S as i,a as c,b as l}from"./SelectionTile-BBl1olc3.js";import{I as r}from"./Icon-Kh1XjJ1-.js";import{w as d}from"./decorator-dmUe8Ksx.js";import"./vue.esm-bundler-ByLATHYC.js";import"./RadioButton-fh3w3Qu6.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./Checkbox-Es7iYIgM.js";import"./v4-CwV2VaSl.js";const{useArgs:m}=__STORYBOOK_MODULE_PREVIEW_API__,C={title:"Components/SelectionTile",component:i,decorators:[t=>({components:{story:t},template:"<div style='display: flex; max-width: 300px;'><story /></div>"}),d]},S=t=>{const[u,p]=m();return{components:{SelectionTile:i},setup(){return t},methods:{onIsSelectedUpdated(a){p({isSelected:a})},onIconClick(){alert("Klik w ikonę")}},data(){return{ICONS:Object.freeze(r)}},template:`
            <SelectionTile
                :title="title"
