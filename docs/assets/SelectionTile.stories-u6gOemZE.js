import{S as i,a as c,b as l}from"./SelectionTile-C_31cZRZ.js";import{I as r}from"./Icon-oMyv8u1q.js";import{w as d}from"./decorator-CSnIf-k5.js";import"./iframe-DkwMlPqF.js";import"../sb-preview/runtime.js";import"./vue.esm-bundler-CzUSCRPq.js";import"./SelectionControl-Wnmwki-I.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./v4-BZawosSj.js";const{useArgs:m}=__STORYBOOK_MODULE_PREVIEW_API__,k={title:"Components/SelectionTile",component:i,decorators:[t=>({components:{story:t},template:"<div style='display: flex; max-width: 300px;'><story /></div>"}),d]},S=t=>{const[u,p]=m();return{components:{SelectionTile:i},setup(){return t},methods:{onIsSelectedUpdated(a){p({isSelected:a})},onIconClick(){alert("Klik w ikonę")}},data(){return{ICONS:Object.freeze(r)}},template:`
            <SelectionTile
                :title="title"
