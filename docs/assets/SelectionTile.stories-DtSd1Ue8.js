import{S as i,a as c,b as l}from"./SelectionTile-BehWmv7g.js";import{I as r}from"./Icon-oTYEsZAB.js";import{w as d}from"./decorator-dmUe8Ksx.js";import"./vue.esm-bundler-CXPnezKh.js";import"./RadioButton-B7tn2CmT.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./Checkbox-CgNIp5W6.js";import"./v4-CwV2VaSl.js";const{useArgs:m}=__STORYBOOK_MODULE_PREVIEW_API__,C={title:"Components/SelectionTile",component:i,decorators:[t=>({components:{story:t},template:"<div style='display: flex; max-width: 300px;'><story /></div>"}),d]},S=t=>{const[u,p]=m();return{components:{SelectionTile:i},setup(){return t},methods:{onIsSelectedUpdated(a){p({isSelected:a})},onIconClick(){alert("Klik w ikonę")}},data(){return{ICONS:Object.freeze(r)}},template:`
            <SelectionTile
                :title="title"
