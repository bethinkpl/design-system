import{D as o,a as l,b as d,c,d as p}from"./DatePicker-DfNJw-NT.js";import{I as D}from"./Icon-ChGia3n4.js";import{D as g}from"./Switch-BtYFtHgw.js";import"./vue.esm-bundler-CWlcb7ht.js";import"./Tile-DWASCVea.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./iframe-Di5TkTnR.js";import"../sb-preview/runtime.js";const{useArgs:b}=__STORYBOOK_MODULE_PREVIEW_API__,P={title:"Components/DatePickers/DatePicker",component:o},h=m=>{const[I,u]=b();return{components:{DatePicker:o,DsSwitch:g},setup(){return m},data(){return{ICONS:Object.freeze(D)}},methods:{updateDate(t){u({date:`${t.getFullYear()}-${t.getMonth()+1}-${t.getDate()}`})}},computed:{formattedDate(){return this.date?new Date(this.date):null},formattedMinDate(){return this.minDate?new Date(this.minDate):null},formattedMaxDate(){return this.maxDate?new Date(this.maxDate):null},formattedDisableDates(){return!this.disableDates||!this.disableDates.length?null:this.disableDates.map(t=>new Date(t))}},template:`
            <date-picker
