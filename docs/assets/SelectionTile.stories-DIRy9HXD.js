import{S as i,a as c,b as l}from"./SelectionTile-BFDhuh-k.js";import{I as r}from"./Icon-CytrC3Ws.js";import{w as d}from"./decorator-CSnIf-k5.js";import"./iframe-BorftRc6.js";import"../sb-preview/runtime.js";import"./vue.esm-bundler-C__e7YM5.js";import"./SelectionControl-k2rO_ZDX.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./v4-BZawosSj.js";const{useArgs:m}=__STORYBOOK_MODULE_PREVIEW_API__,k={title:"Components/SelectionTile",component:i,decorators:[t=>({components:{story:t},template:"<div style='display: flex; max-width: 300px;'><story /></div>"}),d]},S=t=>{const[u,p]=m();return{components:{SelectionTile:i},setup(){return t},methods:{onIsSelectedUpdated(a){p({isSelected:a})},onIconClick(){alert("Klik w ikonę")}},data(){return{ICONS:Object.freeze(r)}},template:`
            <SelectionTile
                :title="title"
