import{W as a,a as m,b as c}from"./Well-BEHivWb0.js";import{C as u,a as d}from"./Chip-KY3rECBC.js";import"./vue.esm-bundler-KKLRPfRG.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./Button-0V5_T79J.js";import"./Icon-q3A7t-gx.js";import"./IconButton-BCnp7r4q.js";import"./device-mzBmLsxe.js";const A={title:"Components/Well",component:a,render:s=>({components:{Well:a},setup(){return{args:s}},template:'<well v-bind="args"><div v-html="args.content" /></well>'}),argTypes:{padding:{control:"select",options:[null,...Object.values(m)]},color:{control:"select",options:Object.values(c)},content:{control:"text"}},parameters:{design:{type:"figma",url:"https://www.figma.com/design/izQdYyiBR1GQgFkaOIfIJI/LMS---DS-Components?node-id=13194-76861&p=f&m=dev"}}},e={args:{padding:null,content:'<h3 style="margin-top: 0">Content</h3>Voluptatem saepe suscipit optio et delectus esse sed velit. Autem maxime soluta aliquam perspiciatis quidem dolor saepe rerum.'}},t={render:s=>({components:{Chip:u,Well:a},setup(){return{args:s,CHIP_RADIUSES:d,content:'<h3 style="margin-top: 0">Content</h3>Voluptatem saepe suscipit optio et delectus esse sed velit. Autem maxime soluta aliquam perspiciatis quidem dolor saepe rerum.'}},template:`<well v-bind="args">
                <template #accessory>
                    <chip
                        label="First Chip"
