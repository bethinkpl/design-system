import{I as o}from"./IconButton-tAYYPmG6.js";import{I as N,f as T,c as S,g,e as v,h as D,i as I}from"./Button-CsOCHUpA.js";import{I as r}from"./Icon-Dg-H1Zak.js";import{w as F}from"./decorator-CSnIf-k5.js";import"./vue.esm-bundler-Dgz4BqwH.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./v4-BZawosSj.js";const J={title:"Components/Buttons/IconButton",component:o,decorators:[F]},h=e=>({components:{IconButton:o},setup(){return e},computed:{isInverted(){return this.color==="inverted"}},data(){return{ICONS:Object.freeze(r),ICON_BUTTON_COLORS:Object.freeze(I)}},template:`<div :class="{ contrastBackground: isInverted }">
    <icon-button
        :icon="ICONS[icon]"
        :size="size"
        :type="type"
...
})`,...(A=(y=O.parameters)==null?void 0:y.docs)==null?void 0:A.source}}};const q=["Interactive","FilledWithLabel","OutlinedRounded","FilledPrimary","IconOnlyInfo","IconOnlyWarning"];export{s as FilledPrimary,n as FilledWithLabel,a as IconOnlyInfo,O as IconOnlyWarning,t as Interactive,c as OutlinedRounded,q as __namedExportsOrder,J as default};
