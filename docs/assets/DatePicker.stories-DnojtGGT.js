import{I as D}from"./Icon-BxW-ny3A.js";import{D as x}from"./Switch-DsNVsFhH.js";import{c as m,a as u,d as g,b as h,e as b}from"./DatePicker-aMS5YOMW.js";import"./vue.esm-bundler-CC_vsnCp.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./Tile-CV9qCJCf.js";import"./iframe-BH6Q2yq5.js";import"../sb-preview/runtime.js";const{useArgs:I}=__STORYBOOK_MODULE_PREVIEW_API__,N={title:"Components/DatePickers/DatePicker",component:m},f=w=>{const[M,r]=I();return{components:{DatePicker:m,DsSwitch:x},setup(){return w},data(){return{ICONS:Object.freeze(D)}},methods:{updateDate(a){r(a?{date:`${a.getFullYear()}-${a.getMonth()+1}-${a.getDate()}`}:{date:null})}},computed:{formattedDate(){return!this.date||this.date===""?null:new Date(this.date)},formattedMinDate(){return!this.minDate||this.minDate==""?null:new Date(this.minDate)},formattedMaxDate(){return!this.maxDate||this.maxDate==""?null:new Date(this.maxDate)},formattedDisableDates(){return!this.disableDates||!this.disableDates.length?null:this.disableDates.map(a=>new Date(a))}},template:`
            <date-picker
