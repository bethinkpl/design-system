import{S as i,a as c,b as l}from"./SelectionTile-DYHS0RQj.js";import{I as r}from"./Icon-ugyemqI_.js";import{w as d}from"./decorator-dmUe8Ksx.js";import"./iframe-DkWW9Pqk.js";import"./vue.esm-bundler-IFOcKaEy.js";import"./SelectionControl-ClR10isn.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./v4-CwV2VaSl.js";const{useArgs:m}=__STORYBOOK_MODULE_PREVIEW_API__,C={title:"Components/SelectionTile",component:i,decorators:[t=>({components:{story:t},template:"<div style='display: flex; max-width: 300px;'><story /></div>"}),d]},S=t=>{const[u,p]=m();return{components:{SelectionTile:i},setup(){return t},methods:{onIsSelectedUpdated(a){p({isSelected:a})},onIconClick(){alert("Klik w ikonę")}},data(){return{ICONS:Object.freeze(r)}},template:`
            <SelectionTile
                :title="title"
...
}`,...(s=(o=e.parameters)==null?void 0:o.docs)==null?void 0:s.source}}};const k=["Interactive"];export{e as Interactive,k as __namedExportsOrder,C as default};
