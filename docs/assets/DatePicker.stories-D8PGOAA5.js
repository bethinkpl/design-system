import{c as p,d as D,b as u,e as m,a as g}from"./DatePicker-DhB0Jwn0.js";import{I as b}from"./Icon-CDRXtlMN.js";import{D as I}from"./Switch-dptsuzQ4.js";import"./vue.esm-bundler-DmkhfO_9.js";import"./Tile-rkYqv0zh.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./iframe-BQgbIZoB.js";import"../sb-preview/runtime.js";const{useArgs:M}=__STORYBOOK_MODULE_PREVIEW_API__,N={title:"Components/DatePickers/DatePicker",component:p},h=S=>{const[T,w]=M();return{components:{DatePicker:p,DsSwitch:I},setup(){return S},data(){return{ICONS:Object.freeze(b)}},methods:{updateDate(a){w({date:`${a.getFullYear()}-${a.getMonth()+1}-${a.getDate()}`})}},computed:{formattedDate(){return this.date?new Date(this.date):null},formattedMinDate(){return this.minDate?new Date(this.minDate):null},formattedMaxDate(){return this.maxDate?new Date(this.maxDate):null},formattedDisableDates(){return!this.disableDates||!this.disableDates.length?null:this.disableDates.map(a=>new Date(a))}},template:`
            <date-picker
