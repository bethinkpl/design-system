import{I as o,a as N,b as T,c as I,d as g,e as D}from"./IconButton-DKdAEAea.js";import{b as l,B as v}from"./Button-DK14lfTl.js";import{I as r}from"./Icon-B79JJqqy.js";import{w as F}from"./decorator-CcL-F-0p.js";import"./vue.esm-bundler-B82wjiSt.js";import"./device-mzBmLsxe.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./chunk-4XZ63LWV-laKUlqim.js";import"./v4-CwV2VaSl.js";const $={title:"Components/Buttons/IconButton",component:o,decorators:[F]},P=e=>({components:{IconButton:o},setup(){return e},computed:{isInverted(){return this.color==="inverted"}},data(){return{ICONS:Object.freeze(r),ICON_BUTTON_COLORS:Object.freeze(N)}},template:`<div :class="{ contrastBackground: isInverted }">
    <icon-button
        :icon="ICONS[icon]"
        :size="size"
        :type="type"
...
})`,...(p=(_=t.parameters)==null?void 0:_.docs)==null?void 0:p.source}}};var u,C,d;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`args => ({
  components: {
    IconButton
  },
  setup() {
...
})`,...(A=(y=O.parameters)==null?void 0:y.docs)==null?void 0:A.source}}};const ee=["Interactive","FilledWithLabel","OutlinedRounded","FilledPrimary","IconOnlyInfo","IconOnlyWarning"];export{n as FilledPrimary,a as FilledWithLabel,s as IconOnlyInfo,O as IconOnlyWarning,t as Interactive,c as OutlinedRounded,ee as __namedExportsOrder,$ as default};
