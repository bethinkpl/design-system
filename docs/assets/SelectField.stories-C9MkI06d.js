import{c as K}from"./vue.esm-bundler-B82wjiSt.js";import{w as J}from"./decorator-CcL-F-0p.js";import{S as c}from"./SelectField-yfwgtkaS.js";import{_ as Q}from"./HelpButton-Ddo5PBYZ.js";import{M as Y}from"./Modal-Y6lEWRWI.js";import{I as s}from"./Icon-B79JJqqy.js";import{a as $,b as X}from"./FormField.stories.shared-C_nfzbZc.js";import{F as m}from"./FormFieldMessage-CsClBSRk.js";import"./chunk-4XZ63LWV-laKUlqim.js";import"./v4-CwV2VaSl.js";import"./VisuallyHidden-CIkFZUwh.js";import"./index-DCEEfTeG.js";import"./Collection-CaJjqgzO.js";import"./FormField-hXs1B1fE.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./useFormFieldWithinForm-Oc6Cld1h.js";import"./SelectList-DZZ2xEty.js";import"./SelectListItemDivider-_eoQ44qb.js";import"./Divider-Bxxz8Ron.js";import"./SelectListSectionTitle-CrraJ6Vs.js";import"./SelectListItem-BJA7RJnu.js";import"./IconButton-DKdAEAea.js";import"./Button-DK14lfTl.js";import"./device-mzBmLsxe.js";import"./Tooltip-BAbGxXLW.js";import"./useLegacyI18n-CQM7nz1H.js";import"./FeatureIcon-B6uzddnt.js";const Z=[{value:"pl",label:"Polska"},{value:"de",label:"Niemcy"},{value:"cz",label:"Czechy"},{value:"sk",label:"Słowacja",isDisabled:!0},{value:"jp",label:"Japonia"}],q=[{value:"all",label:"Wszystkie kraje"},{label:"Europa",options:[{value:"pl",label:"Polska"},{value:"de",label:"Niemcy"},{value:"cz",label:"Czechy"}]},{label:"Azja",options:[{value:"jp",label:"Japonia"},{value:"kr",label:"Korea Południowa"}]}],V=[{value:"draft",label:"Szkic",eyebrowText:"Status",iconLeft:s.FA_PENCIL},{value:"published",label:"Opublikowany",eyebrowText:"Status",iconLeft:s.FA_CHECK_SOLID},{value:"archived",label:"Zarchiwizowany",eyebrowText:"Status",iconLeft:s.FA_BOX}],U=Array.from({length:30},(t,i)=>({value:`option-${i+1}`,label:`Opcja numer ${i+1}`})),ee=[{value:"anatomia",label:"Anatomia prawidłowa człowieka z elementami histologii"},{value:"biochemia",label:"Biochemia kliniczna i diagnostyka laboratoryjna"},{value:"farmakologia",label:"Farmakologia z toksykologią dla kierunku lekarskiego"},{value:"short",label:"Krótka nazwa"},{value:"bardzo-dlugi",label:"Wyjątkowo długa nazwa kursu, która nie zmieści się w dostępnej szerokości okna i zostanie skrócona wielokropkiem"}];function te(t){return typeof t=="string"&&t.trim()!==""&&!Number.isNaN(Number(t))?Number(t):t}const Ae={title:"Components/Form/SelectField",component:c,decorators:[J],render:t=>({components:{SelectField:c,HelpButton:Q,Modal:Y},setup(){const i=K(()=>{const{help:ae,labelAside:re,message:oe,fieldStatus:se,...u}=t;return{...u,maxHeight:te(u.maxHeight)}});return{args:t,props:i,FORM_FIELD_STATES:m,ICONS:s}},data:()=>({value:void 0}),template:`<SelectField v-bind="props" :left-icon="props.leftIcon ? ICONS[props.leftIcon] : null" v-model="value">
