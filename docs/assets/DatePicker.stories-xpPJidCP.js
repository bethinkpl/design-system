import{I as D}from"./Icon-Kh1XjJ1-.js";import{D as x}from"./Switch-C2l7WQFc.js";import{c as m,a as u,d as g,b as h,e as b}from"./DatePicker-K7HuBagS.js";import"./vue.esm-bundler-ByLATHYC.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./Tile-BeKWyKLU.js";import"./iframe-B-gX_8mC.js";const{useArgs:I}=__STORYBOOK_MODULE_PREVIEW_API__,v={title:"Components/DatePickers/DatePicker",component:m},f=w=>{const[M,r]=I();return{components:{DatePicker:m,DsSwitch:x},setup(){return w},data(){return{ICONS:Object.freeze(D)}},methods:{updateDate(a){r(a?{date:`${a.getFullYear()}-${a.getMonth()+1}-${a.getDate()}`}:{date:null})}},computed:{formattedDate(){return!this.date||this.date===""?null:new Date(this.date)},formattedMinDate(){return!this.minDate||this.minDate==""?null:new Date(this.minDate)},formattedMaxDate(){return!this.maxDate||this.maxDate==""?null:new Date(this.maxDate)},formattedDisableDates(){return!this.disableDates||!this.disableDates.length?null:this.disableDates.map(a=>new Date(a))}},template:`
            <date-picker
