import{C as s,a as r,b as u,c as v,d}from"./Checkbox-DfwxfTJI.js";import{w as S}from"./decorator-dmUe8Ksx.js";import{c as o}from"./vue.esm-bundler-BEu-HfQJ.js";import"./index-yKlVThWI.js";import"./Icon-B2cczydO.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./v4-CwV2VaSl.js";const{useArgs:C}=__STORYBOOK_MODULE_PREVIEW_API__,L={title:"Components/Form/Checkbox",component:s,decorators:[S]},b=t=>{const[g,c]=C();return{components:{Checkbox:s},setup(){const p=o(()=>{const{default:V,modelValue:_,...f}=t;return f}),m=o(()=>t.default),i=o(()=>t.modelValue);return{defaultSlot:m,props:p,modelValue:i,updateArgs:c}},template:`
            <Checkbox 
                v-bind="props"
