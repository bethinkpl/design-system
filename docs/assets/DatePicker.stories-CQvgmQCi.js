import{D as o,a as l,b as c,c as d,d as D}from"./DatePicker-C2bxBng6.js";import{I as p}from"./Icon-Daqcn32A.js";import{D as g}from"./Switch-DdvT2o45.js";import"./vue.esm-bundler-CzUSCRPq.js";import"./Tile-Nqx7KGXe.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./iframe-DDfug5VJ.js";import"../sb-preview/runtime.js";const{useArgs:b}=__STORYBOOK_MODULE_PREVIEW_API__,x={title:"Components/DatePickers/DatePicker",component:o},h=m=>{const[I,u]=b();return{components:{DatePicker:o,DsSwitch:g},setup(){return m},data(){return{ICONS:Object.freeze(p)}},methods:{updateDate(t){u({date:`${t.getFullYear()}-${t.getMonth()+1}-${t.getDate()}`})}},computed:{formattedDate(){return this.date?new Date(this.date):null},formattedMinDate(){return this.minDate?new Date(this.minDate):null},formattedMaxDate(){return this.maxDate?new Date(this.maxDate):null},formattedDisableDates(){return!this.disableDates||!this.disableDates.length?null:this.disableDates.map(t=>new Date(t))}},template:`
            <date-picker
