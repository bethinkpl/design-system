import{S as i,a as c,b as r}from"./SelectionTile-Bx5rmHnr.js";import{I as l}from"./Icon-DTVXTHLv.js";import{w as d}from"./decorator-dmUe8Ksx.js";import"./vue.esm-bundler-vCYTN4Ic.js";import"./RadioButton-BqrcPSy1.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./Checkbox-Bt1FF91J.js";import"./VisuallyHidden-D4rawdGf.js";import"./index-Bp3klHO6.js";import"./v4-CwV2VaSl.js";const{useArgs:m}=__STORYBOOK_MODULE_PREVIEW_API__,f={title:"Components/SelectionTile",component:i,decorators:[t=>({components:{story:t},template:"<div style='display: flex; max-width: 300px;'><story /></div>"}),d]},S=t=>{const[u,p]=m();return{components:{SelectionTile:i},setup(){return t},methods:{onIsSelectedUpdated(a){p({isSelected:a})},onIconClick(){alert("Klik w ikonę")}},data(){return{ICONS:Object.freeze(l)}},template:`
            <SelectionTile
                :title="title"
...
}`,...(s=(o=e.parameters)==null?void 0:o.docs)==null?void 0:s.source}}};const A=["Interactive"];export{e as Interactive,A as __namedExportsOrder,f as default};
