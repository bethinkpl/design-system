...
describe('Button', () => {
	...
	test.each([
		...
		[{ props: { color: BUTTON_COLORS.MINOR }, expectedClass: '-minor' }],
		[{ props: { color: BUTTON_COLORS.DANGER }, expectedClass: '-danger' }],
		[{ props: { color: BUTTON_COLORS.WARNING }, expectedClass: '-warning' }],
		[{ props: { color: BUTTON_COLORS.SUCCESS }, expectedClass: '-success' }],
